...
[aria-pressed="true"] .toggle__backdrop {
  filter: hue-rotate(280deg) saturate(1.2) brightness(1.06);
}
[aria-pressed="true"] .stars path {
  fill: #efe9ff;
}
[aria-pressed="true"] .toggle:after {
  box-shadow: 0 -1px 2px 0 rgba(100, 72, 160, 0.35) inset,
    0 1px 2px 0 rgba(180, 160, 220, 0.45) inset;
}
